...
# Eliminate_red_chapter('img_imread','img_output') #消除红章
# get_table_structure('img_imread','img_output')#获取表结构
# extract_red_chapter('img_imread','img_output') #提取红章
# repair('img_imread','img_output') #修复
